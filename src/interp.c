...
const	struct	cmd_type	cmd_table	[] =
{
    ...
    { "clans",	do_clanlist,	POS_SLEEPING, 0, LOG_NORMAL, 1 },
    ...
    { "cpromote", do_promote, POS_SLEEPING, 0, LOG_NORMAL, 1 },
    ...
    { "automap", do_automap, POS_DEAD, 0, LOG_NORMAL, 1 },
    ...
    { "broadcast",	do_broadcast,	POS_DEAD,	L4,  LOG_NORMAL, 1 },
    ...
    { "map", do_mapper, POS_DEAD, 0, LOG_NORMAL, 1 },
    ...
    { ",",		do_gocial,	POS_SLEEPING,	 0,  LOG_NORMAL, 0 },
    { "gocial",         do_gocial,      POS_SLEEPING,    0,LOG_NORMAL, 1 },
    ...
    { "lore",	do_lore,	POS_FIGHTING,	0,	LOG_NORMAL, 1 },
    ...
    { "unban",		do_allow,	POS_DEAD,	L3,  LOG_ALWAYS, 1 },
    ...
    { "dc",	do_disconnect,	POS_DEAD,	L3,	LOG_ALWAYS, 0 },
    { "flag",		do_flag,	POS_DEAD,	L4,  LOG_ALWAYS, 1 },
    { "freeze",		do_freeze,	POS_DEAD,	L4,  LOG_ALWAYS, 1 },
    { "permban",	do_permban,	POS_DEAD,	L3,  LOG_ALWAYS, 1 },
    ...
    { "send",		do_pecho,	POS_DEAD,	L4,  LOG_ALWAYS, 1 }, 
    ...
    { "rmessage",	do_rmsg,	POS_DEAD,	L4, LOG_NORMAL, 1  },
     ...
     * OLC
     */
    { "edit",		do_olc,		POS_DEAD,  102,  LOG_NORMAL, 1 },
    { "asave",          do_asave,	POS_DEAD,  102,  LOG_NORMAL, 1 },
    { "alist",		do_alist,	POS_DEAD,   IM,  LOG_NORMAL, 1 },
    { "resets",		do_resets,	POS_DEAD,  104,  LOG_NORMAL, 1 },
    { "redit",		do_redit,	POS_DEAD,  102,	 LOG_NORMAL, 1 },
    { "medit",		do_medit,	POS_DEAD,  102,	 LOG_NORMAL, 1 },
    { "aedit",		do_aedit,	POS_DEAD,  104,  LOG_NORMAL, 1 },
    { "oedit",		do_oedit,	POS_DEAD,  102,  LOG_NORMAL, 1 },
    { "mpedit",		do_mpedit,	POS_DEAD,  104,  LOG_NORMAL, 1 },
    { "hedit",		do_hedit,	POS_DEAD,  109,  LOG_NORMAL, 1 },
    { "gedit",		do_gedit,	POS_DEAD,  109,  LOG_NORMAL, 1 },
    { "gsave", 		save_guilds, 	POS_DEAD,  109,  LOG_NORMAL, 1 },
    /*
     * End of list.
     */
