...
*/
    {
	"halfling",	"Hfl",	5,	{ 200, 200, 150, 100 },
	{ "sneak", "hide" },
	{ 11, 14, 12, 15, 13 }, { 15, 20, 16, 21, 18 }, SIZE_SMALL,
	HALFLING_STARTROOM
    }
};
 ...
 */
    ...
    {
	"acid blast",		{ 55, 93, 101, 101 }, 	{ 1,  1,  2,  2},
    ...
    {
	"blindness",		{  24, 15, 101, 101},     { 1,  1,  2,  2},
    ...
    {
	"burning hands",	{  13, 87, 101, 101},     { 1,  1,  2,  2},
    ...
    {
	"call lightning",	{ 101, 36, 101, 101},     { 1,  1,  2,  2},
	spell_call_lightning,	TAR_IGNORE,		POS_FIGHTING,
	NULL,			SLOT( 6),	15,	12,
	"lightning bolt",	"!Call Lightning!",	""
    },

    {   "calm",			{ 85, 32, 101, 101},     { 1,  1,  2,  2},
    ...
    {
	"cancellation",		{ 51, 51, 101, 101},     { 1,  1,  2,  2},
    ...
    {
	"cause critical",	{ 45, 45, 101, 101},     { 1,  1,  2,  2},
    ...
    {
	"cause light",		{ 5, 2, 101, 101},     { 1,  1,  2,  2},
    ...
    {
	"cause serious",	{ 20, 23, 101, 101},     { 1,  1,  2,  2},
    ...
    {   
	"chain lightning",	{ 66, 101, 101, 101},     { 1,  1,  2,  2},
    ...
    {
	"change sex",		{ 53, 53, 101, 101 },     { 1,  1,  2,  2},
    ...
    {
	"charm person",		{ 40, 30, 50, 101},     { 1,  1,  2,  2},
    ...
    {
	"chill touch",		{  12, 101, 101, 101},     { 1,  1,  2,  2},
    ...
    {
	"colour spray",		{ 32, 101, 101, 101},     { 1,  1,  2,  2},
    ...
    {
	"continual light",	{ 11, 8, 101, 101},     { 1,  1,  2,  2},
    ...
    {
	"control weather",	{ 101, 48, 101, 101},     { 1,  1,  2,  2},
    ...
    {
	"create food",		{ 19, 10, 101, 101},     { 1,  1,  2,  2},
    ...
    {
	"create rose",		{ 32, 21, 101, 101}, 	{ 1, 1, 2, 2 },
    ...
    {
	"create spring",	{ 28, 34, 101, 101},     { 1,  1,  2,  2},
    ...
    {
	"create water",		{ 15, 5, 101, 101},     { 1,  1,  2,  2},
    ...
    {
	"cure blindness",	{ 101, 11, 101, 101},     { 1,  1,  2,  2},
    ...
    {
	"cure critical",	{ 101, 25, 101, 101},     { 1,  1,  2,  2},
    ...
    {
	"cure disease",		{ 101, 26, 101, 101},     { 1,  1,  2,  2},
    ...
    {
	"cure light",		{ 101, 4, 101, 101},     { 1,  1,  2,  2},
    ...
    {
	"cure poison",		{ 101, 28, 101, 101},     { 1,  1,  2,  2},
    ...
    {
	"cure serious",		{ 101, 14, 101, 101},     { 1,  1,  2,  2},
    ...
    {
	"demonfire",		{ 76, 68, 101, 101},     { 1,  1,  2,  2},
    ...
    {
	"detect evil",		{ 22, 22, 101, 101},     { 1,  1,  2,  2},
    ...
    {
        "detect good",          { 23, 22, 101, 101},     { 1,  1,  2,  2},
    ...
    {
	"detect hidden",	{ 24, 22, 24, 101},     { 1,  1,  2,  2},
    ...
    {
	"detect invis",		{  25, 16, 11, 101},     { 1,  1,  2,  2},
    ...
    {
	"detect magic",		{  26, 11, 8, 101},     { 1,  1,  2,  2},
    ...
    {
	"detect poison",	{ 27, 14, 18, 101},     { 1,  1,  2,  2},
    ...
    {
	"dispel evil",		{ 101, 30, 101, 101},     { 1,  1,  2,  2},
    ...
    {
        "dispel good",          { 101, 30, 101, 101},     { 1,  1,  2,  2},
    ...
    {
	"dispel magic",		{ 48, 48, 101, 101},     { 1,  1,  2,  2},
    ...
    {
	"earthquake",		{ 83, 20, 101, 101},     { 1,  1,  2,  2},
    ...
    {
	"enchant armor",	{ 31, 90, 101, 101},	{ 2,  2,  4,  4 },
    ...
    {
	"enchant weapon",	{ 32, 90, 101, 101},     { 2,  2, 4,  4},
    ...
    {
	"energy drain",		{ 38, 44, 101, 101},     { 1,  1,  2,  2},
    ...
    {
	"faerie fire",		{  12, 5, 101, 101},     { 1,  1,  2,  2},
    ...
    {
	"faerie fog",		{ 28, 41, 101, 101},     { 1,  1,  2,  2},
    ...
    {
	"fireball",		{ 44, 89, 101, 101},     { 1,  1,  2,  2},
    ...
    {
	"fireproof",		{ 25, 24, 101, 101},	{ 1, 1, 2, 2},
    ...
    {
	"flamestrike",		{ 34, 40, 101, 101},     { 1,  1,  2,  2},
    ...
    {
	"floating disc",	{  7, 19, 101, 101},	{ 1, 1, 2, 2},
    ...
    {
	"giant strength",	{  41, 42, 101, 101},     { 1,  1,  2,  2},
    ...
    {
	"heat metal",		{ 73, 42, 101, 101},	{ 1, 1, 2, 2 },
    ...
    {
	"holy word",		{ 101, 71, 101, 101},	{ 2,  2,  4,  4},
    ...
    {
	"infravision",		{  18, 26, 101, 101},     { 1,  1,  2,  2},
    ...
    {
	"invisibility",		{ 9, 37, 17, 101},     { 1,  1,  2,  2},
    ...
    {
	"know alignment",	{  24, 17, 101, 101},     { 1,  1,  2,  2},
    ...
    {
	"lightning bolt",	{ 25, 46, 101, 101},     { 1,  1,  2,  2},
    ...
    {
	"locate object",	{ 17, 30, 101, 101},     { 1,  1,  2,  2},
    ...
    {
	"magic missile",	{  1, 101, 101, 101},     { 1,  1,  2,  2},
    ...
    {
	"mass healing",		{ 101, 75, 101, 101},	{ 2,  2,  4,  4},
    ...
    {
	"mass invis",		{ 43, 49, 101, 101},     { 1,  1,  2,  2},
    ...
    {
	"pass door",		{ 48, 63, 49, 101},     { 1,  1,  2,  2},
    ...
    {
	"protection evil",	{ 24, 18, 101, 101},     { 1,  1,  2,  2},
    ...
    {
        "protection good",      { 24, 18, 101, 101},     { 1,  1,  2,  2},
    ...
    {
        "ray of truth",         { 101, 69, 101, 101},     { 1,  1,  2,  2},
    ...
    {
	"recharge",		{ 18, 63, 101, 101}, 	{ 1, 1, 2, 2 },
    ...
    {
	"remove curse",		{ 101, 35, 101, 101},     { 1,  1,  2,  2},
    ...
    {
	"sanctuary",		{ 52, 39, 101, 101},     { 1,  1,  2,  2},
    ...
    {
	"shocking grasp",	{  20, 101, 101, 101},     { 1,  1,  2,  2},
    ...
    {
	"stone skin",		{ 49, 70, 101, 101},     { 1,  1,  2,  2},
    ...
    {
	"teleport",		{  24, 44, 101, 101},     { 1,  1,  2,  2},
    ...
    {
	"ventriloquate",	{ 1, 101, 2, 101},     { 1,  1,  2,  2},
    ...
    {
	"word of recall",	{ 63, 56, 101, 101},     { 1,  1,  2,  2},
 ...
 */
    {
	"acid breath",		{ 62, 101, 101, 101},     { 1,  1,  2,  2},
    ...
    {
	"fire breath",		{ 80, 90, 101, 101},     { 1,  1,  2,  2},
    ...
    {
	"frost breath",		{ 67, 101, 101, 101},     { 1,  1,  2,  2},
    ...
    {
	"gas breath",		{ 77, 101, 101, 101},     { 1,  1,  2,  2},
    ...
    {
	"lightning breath",	{ 74, 101, 101, 101},     { 1,  1,  2,  2},
 ...
 */
    {
        "general purpose",      { 104, 104, 104, 104},	{ 0, 0, 0, 0 },
    ...
    {
        "high explosive",       { 104, 104, 104, 104},	{ 0, 0, 0, 0 },
...
/* combat and weapons skills */
    ...
    {
	"berserk",		{ 101, 101, 101, 27},	{ 0, 0, 0, 5},
        spell_null,             TAR_IGNORE,             POS_FIGHTING,
    ...
    {
	"dirt kicking",		{ 101, 101, 4, 4},	{ 0, 0, 4, 4}, 
	spell_null,		TAR_IGNORE,		POS_FIGHTING,
    ...
    {
        "enhanced damage",      { 101, 101, 101, 1},     { 10, 9, 5, 3},
        spell_null,             TAR_IGNORE,             POS_FIGHTING,
    ...
    {
	"hand to hand",		{ 101, 101, 22, 9},	{ 8, 5, 6, 4},
	spell_null,		TAR_IGNORE,		POS_FIGHTING,
    ...
    {
        "second attack",        { 45, 36, 18, 7},     { 10, 8, 5, 3},
        spell_null,             TAR_IGNORE,             POS_FIGHTING,
    ...
    {
        "third attack",         { 101, 101, 36, 18},     { 0, 0, 10, 4},
        spell_null,             TAR_IGNORE,             POS_FIGHTING,
...
/* non-combat skills */
    ...
    { 
	"fast healing",		{ 101, 13, 21, 9},	{ 8, 5, 6, 4},
    ...
    {
	"meditation",		{ 9, 9, 101, 101},	{ 5, 5, 8, 8},
	spell_null,		TAR_IGNORE,		POS_SLEEPING,
    ...
    {
	"pick lock",		{ 101, 101, 10, 101},	{ 8, 8, 4, 8},
	spell_null,		TAR_IGNORE,		POS_STANDING,
