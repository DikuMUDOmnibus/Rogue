...
#define L2	MAX_LEVEL - 2	/* asso */
#define L3	MAX_LEVEL - 3	/* sec/pr */
#define L4 	MAX_LEVEL - 4	/* sr.build */
#define L5	MAX_LEVEL - 5	/* questor */
#define L6	MAX_LEVEL - 6	/* terraformer */
#define L7	MAX_LEVEL - 7	/* webmaster */
#define L8	MAX_LEVEL - 8	/* trainee */
#define IM	LEVEL_IMMORTAL 	/* imm */
